#' Vigneau-Mahevas LFD raising method
#'
#' Apply the Vigneau-Mahevas raising method to prepared LFD inputs.
#'
#' This low-level method is called by `landings_rdbfis()` or
#' `discards_rdbfis()`. It raises the summed samples to totals at stratum
#' level.
#'
...
#' @export vigneau_mahevas

vigneau_mahevas <- function(data, land){
  data1        <- data
